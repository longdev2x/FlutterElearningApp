        ...
        data: (data) {
          ...
          return Padding(
            ...
            child: ListView.builder(itemCount: data.length,itemBuilder: (context, index) {
              ...
              return InkWell(
                onTap: () {
                  Navigator.of(context).pushNamed(AppRoutesNames.courseDetail, arguments: {'id' : course.id});
                },
                child: Container(
                      ...
                      child: Row(
                        children: [Row(children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                image: NetworkImage('${AppConstants.imageUploadsPath}${course.thumbnail}'),
                          ...
                          Column(
                            ...
                            children: [
                          Text14Normal(text: course.name ?? '', color: AppColors.primaryText, fontweight: FontWeight.bold,),
                          Text11Normal(text: '${course.lessonNum} lessons', color: AppColors.primarySecondaryElementText,)
                          ]),
                                        ]),
                          
                          const Spacer(),
                
                          Text13Normal(text: '\$${course.price.toString()}', color: AppColors.primaryText, fontweight: FontWeight.bold,),
                        ],
                      ),
                ),
              );
